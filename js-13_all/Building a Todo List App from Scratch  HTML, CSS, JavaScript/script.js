...
const totalCategoryTaskP = document.querySelector('.category-tasks');
...
const calculateTotal = () => {
  ...
  totalCategoryTaskP.innerHTML = `${categoryTasks.length} Tasks`;
...
const renderCategories = () => {
  ...
  categories.forEach((category) => {
    ...
    div.addEventListener('click', () => {
      ...
      totalTasks.innerHTML = category.title;
